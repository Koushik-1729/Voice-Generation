...
# docker build -t super_grow_assignment .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name super_grow_assignment super_grow_assignment
